...
//        initTabs();
    ...
    private void initTabs() {
        TabPagerFragmentAdapter adapter = new TabPagerFragmentAdapter(getSupportFragmentManager(), getApplicationContext());
...
//                switch (position) {
//                    case TabConstants.TAB_CITY_STREAM: {
//                        setCheckedNavigationDrawerMenuItem(R.id.navigation_action_city_stream);
//                        break;
//                }
//                    case TabConstants.TAB_CITY_MAP: {
//                        setCheckedNavigationDrawerMenuItem(R.id.navigation_action_city_map);
//                        break;
//                    }
//                    case TabConstants.TAB_FILTER: {
//                        setCheckedNavigationDrawerMenuItem(R.id.navigation_action_filter);
//                        break;
//                    }
//                }
            }
